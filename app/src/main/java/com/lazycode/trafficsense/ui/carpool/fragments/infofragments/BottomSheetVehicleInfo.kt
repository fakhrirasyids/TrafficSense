...
import com.lazycode.trafficsense.databinding.FragmentBottomSheetVehicleInfoBinding
...
class BottomSheetVehicleInfo : BottomSheetDialogFragment() {
    private var _binding: FragmentBottomSheetVehicleInfoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBottomSheetVehicleInfoBinding.inflate(inflater, container, false)
        setTransparentBackground()
        val vehicleName = this.arguments?.getString(KEY_VEHICLE_NAME)
        val vehicleCapacity = this.arguments?.getString(KEY_VEHICLE_CAPACITY)

        binding.apply {
            tvVehicleName.text = vehicleName
            tvVehicleCapacity.text = vehicleCapacity
        }
    ...
    companion object {
        const val KEY_VEHICLE_NAME = "key_vehicle_name"
        const val KEY_VEHICLE_CAPACITY = "key_vehicle_capacity"
    }
}