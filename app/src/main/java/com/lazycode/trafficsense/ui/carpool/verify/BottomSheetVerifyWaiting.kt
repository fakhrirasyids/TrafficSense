...
class BottomSheetVerifyWaiting : BottomSheetDialogFragment() {
    private var _binding: FragmentBottomSheetVerifyWaitingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBottomSheetVerifyWaitingBinding.inflate(inflater, container, false)
